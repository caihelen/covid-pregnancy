...
## Igfr related pathways: ras, MAPK, mTOR
...
## immune function
pathview(gene.data = fold_changes, pathway.id = "mmu04062", species = "mmu",
    low=list(gene="#FDE725"),
    high=list(gene="#440154"),
    mid=list(gene="#21908CFF"))
pathview(gene.data = fold_changes, pathway.id = "mmu04620", species = "mmu",
    low=list(gene="#FDE725"),
    high=list(gene="#440154"),
    mid=list(gene="#21908CFF"))

## things to consider in development: Wnt, hedgehog, apoptosis
pathview(gene.data = fold_changes, pathway.id = "mmu04310", species = "mmu",
    low=list(gene="#FDE725"),
    high=list(gene="#440154"),
    mid=list(gene="#21908CFF"))
pathview(gene.data = fold_changes, pathway.id = "mmu04340", species = "mmu",
    low=list(gene="#FDE725"),
    high=list(gene="#440154"),
    mid=list(gene="#21908CFF"))
pathview(gene.data = fold_changes, pathway.id = "mmu04210", species = "mmu",
    low=list(gene="#FDE725"),
    high=list(gene="#440154"),
    mid=list(gene="#21908CFF"))
